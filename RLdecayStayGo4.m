function Out = RLdecayStayGo4(num_trial,RLtype,RLparas,rewsize,decay_rate,DAdep_paras)
...
%-----
% Out = RLdecayStayGo4(num_trial,RLtype,RLparas,rewsize,decay_rate,DAdep_paras);
%
% <input variables>
...
% reward
Rs = [zeros(1,num_state-1), rewsize];  % reward at each state (time step) for all the trials
