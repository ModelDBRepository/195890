...
% parameters to vary
RLparas = [0.4, 5, 1]; % [alpha (learning rate), beta (inverse temperature), gamma (time discount factor)]
ds = [0:0.0001:0.0375 0.03751:0.00001:0.0390 0.0391:0.0001:0.0445 0.04451:0.00001:0.0455 0.0456:0.0001:0.1]; % set of decay-degree
