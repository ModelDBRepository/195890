...
load used_rand_twister_for_Fig11D
...
Dsim.rand_twister = used_rand_twister_for_Fig11D.alpha;
...
Dalpha = Dsim;
save D_rewardsize1p50_alpha Dalpha
clear Dsim

% sim varying beta
%rand('twister',sum(100*clock));
%Dsim.rand_twister = rand('twister');
Dsim.rand_twister = used_rand_twister_for_Fig11D.beta;
rand('twister',Dsim.rand_twister);
...
Dsim.ntspt_std = std(Dsim.ntspt,1,3);
Dbeta = Dsim;
save D_rewardsize1p50_beta Dbeta
clear Dsim

% sim varying gamma
%rand('twister',sum(100*clock));
%Dsim.rand_twister = rand('twister');
Dsim.rand_twister = used_rand_twister_for_Fig11D.gamma;
rand('twister',Dsim.rand_twister);
...
Dsim.ntspt_std = std(Dsim.ntspt,1,3);
Dgamma = Dsim;
save D_rewardsize1p50_gamma Dgamma
clear Dsim
