...
load used_rand_twister_for_Fig11C
...
Dsim.rand_twister = used_rand_twister_for_Fig11C.alpha;
...
Dalpha = Dsim;
save D_rewardsize1p25_alpha Dalpha
clear Dsim

% sim varying beta
%rand('twister',sum(100*clock));
%Dsim.rand_twister = rand('twister');
Dsim.rand_twister = used_rand_twister_for_Fig11C.beta;
rand('twister',Dsim.rand_twister);
...
Dsim.ntspt_std = std(Dsim.ntspt,1,3);
Dbeta = Dsim;
save D_rewardsize1p25_beta Dbeta
clear Dsim

% sim varying gamma
%rand('twister',sum(100*clock));
%Dsim.rand_twister = rand('twister');
Dsim.rand_twister = used_rand_twister_for_Fig11C.gamma;
rand('twister',Dsim.rand_twister);
...
Dsim.ntspt_std = std(Dsim.ntspt,1,3);
Dgamma = Dsim;
save D_rewardsize1p25_gamma Dgamma
clear Dsim
