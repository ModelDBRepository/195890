function Out = RLdecayStayGo6(num_state,num_trial,RLtype,RLparas,decay_rate,DAdep_paras)
...
%-----
% Out = RLdecayStayGo6(num_state,num_trial,RLtype,RLparas,decay_rate,DAdep_paras);
%
% <input variables>
