...
% parameters to vary
RLparas = [0.6, 5, 1]; % [alpha (learning rate), beta (inverse temperature), gamma (time discount factor)]
ds = [0:0.0001:0.0564 0.05641:0.00001:0.0575 0.0576:0.0001:0.0660 0.06601:0.00001:0.0720 0.0721:0.0001:0.1]; % set of decay-degree
